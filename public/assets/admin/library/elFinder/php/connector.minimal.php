...
$pathTrash = '../files/.trash/';
$tmbURL = dirname($_SERVER['PHP_SELF']) . '/../files/.trash/.tmb/';


// new path
// $config = $this->getDI()->get('config')->application;
// $config = $this->getConfig()->application;

// $path = $config->frontendAssets;
// $URL = $config->frontendAssetsDir;
// $pathTrash = $config->frontendAssets . '.trash/';
// $tmbURL = $config->frontendAssetsDir . '.trash/.tmb/';
...
$URL =  '/assets/';
$pathTrash = $baseDir . '/public/assets/' . '.trash/';
$tmbURL =  '/assets/' . '.trash/.tmb/';
