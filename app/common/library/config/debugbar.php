...
return array(
    ...
    'storage'     => array(
        ...
        'path'    => BASE_PATH . '/Runtime/debugbar', // For file driver
    ...
    'collectors' => array(
        ...
        'doctrine'        => true, // Display the sql statments infomations. Just for Doctrine ORM.'db' and 'doctrine', you only can choose one!
